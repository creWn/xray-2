...
static pvoid		tga_reader_allocate			( u32 size, bool is_additional_buffer )
{
	if(is_additional_buffer)
		return MT_MALLOC(size, "tempprary for image");
...
: inplace_unmanaged_cook(resources::texture_tga_to_argb_class, reuse_false, use_current_thread_id, use_cooker_thread_id) {}
