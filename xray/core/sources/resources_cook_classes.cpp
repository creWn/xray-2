...
managed_cook::managed_cook	(class_id resource_class, reuse_enum reuse_type, unsigned creation_thread_id) 
:	cook_base(resource_class, reuse_type, flag_creates_managed_resource, thread_id_unset, creation_thread_id)
{
}

inplace_managed_cook::inplace_managed_cook	(class_id resource_class, reuse_enum reuse_type, unsigned creation_thread_id)
...
unmanaged_cook::unmanaged_cook (class_id resource_class, reuse_enum reuse_type, unsigned creation_thread_id, unsigned allocate_thread_id)
...
inplace_unmanaged_cook::inplace_unmanaged_cook (class_id resource_class, reuse_enum reuse_type, 
												unsigned creation_thread_id, unsigned allocate_thread_id)
:	cook_base(resource_class, reuse_type, flag_does_inplace_cook, allocate_thread_id, creation_thread_id)
{
}

translate_query_cook::translate_query_cook (class_id resource_class, reuse_enum reuse_type, unsigned translate_query_thread)
