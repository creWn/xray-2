...
public:
	...
	iterator				begin					();
	iterator				end						();
	const_iterator			begin					() const { return const_cast<hash_multiset*>(this)->begin();	 }
	const_iterator			end						() const { return const_cast<hash_multiset*>(this)->end();	 }
