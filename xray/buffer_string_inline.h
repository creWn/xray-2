...
template <typename input_iterator>
void   buffer_string::assign (input_iterator const& begin_src, input_iterator const& end_src)
{
	clear						();
	append						(begin_src, end_src);
}
...
inline
void   buffer_string::append (value_type const c)
{
...
inline
void   buffer_string::append (pcstr const begin_src, pcstr const end_src)
{
...
inline
void   buffer_string::append (pcstr const c_string)
{
