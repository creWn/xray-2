...
void	render( const dxJointContact	&contact, render::debug::renderer& renderer )
{
	...
	renderer.draw_sphere( p0, 0.01f, math::color( 255u, 255u, 0u, 255u ) );
	//world.debug(user_id).draw_arrow( p0, p1, math::color_xrgb( 255, 0, 0 ) );

	renderer.draw_line( p0, p1, math::color( 255u, 0u, 0u, 255u ) );
}
